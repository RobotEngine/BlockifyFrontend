...
// (await getModule("dropdown")).openDropdown(findI("dropdownButtonInvite"), [["Block Item", "var(--themeColor)", function(a) { console.log(a); }], ["Block Item", "var(--themeColor)", function(a) { console.log(a); }]]);
